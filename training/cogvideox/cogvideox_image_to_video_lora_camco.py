...
## DO NOT LOAD CogVideoXTransformer3DModel from 'custom_diffusers' --> Attn is 4D-inflated in 'custom_diffusers'
...
def run_validation(
    ...
    for validation_image in validation_images_list:
        ...
        if "horizontal-" in filename:
            id_token = "CAMERA_PAN_RIGHT" + " " + "Camera movement pan right,"
        elif "horizontal+" in filename:
            id_token = "CAMERA_PAN_LEFT" + " " + "Camera movement pan left,"
        elif "vertical-" in filename:
            id_token = "CAMERA_TILT_UP" + " " + "Camera movement tilt up,"
        elif "vertical+" in filename:
            id_token = "CAMERA_TILT_DOWN" + " " + "Camera movement tilt down,"
