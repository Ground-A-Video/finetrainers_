...
## VIBID Sampler custom functions ##
...
class CogVideoXInterpolationPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin): 
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                if not isinstance(self.scheduler, CogVideoXDPMScheduler):
                    ...
                    ## TODO (2) renoise x_t-1 to x_t
                    
                    ## TODO (3) flip x_t-1 and replace image conditioning (plug in last frame img_emb)

                    ## TODO (4) denoise x_t to x_t-1

                    ## TODO (5) flip x_t-1 and replace image conditioning (plug in first frame img_emb)
